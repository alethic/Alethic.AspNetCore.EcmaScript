...
server.listen(requestedPortOrZero, 'localhost', function () {
	...
	console.log('[Alethic.AspNetCore.EcmaScript.Node.HttpNodeHost:Listening on {' + addressInfo.address + '} port ' + addressInfo.port + '\]');

	// Signal to the NodeServices base class that we're ready to accept invocations
	console.log('[Alethic.AspNetCore.EcmaScript.Node:Listening]');
});
