...
internal static class Prerenderer
{
	...
	/// <param name="nodeServices">The instance of <see cref="INodeService"/> that will be used to invoke JavaScript code.</param>
	...
	static string GetNodeScriptFilename(CancellationToken applicationStoppingToken)
	{
		lock (CreateNodeScriptLock)
		{
			if (NodeScript == null)
			{
				var script = EmbeddedResourceReader.Read(typeof(Prerenderer), "prerenderer.js");
